...
if(APPLE AND NOT OGRE_BUILD_PLATFORM_APPLE_IOS)
	...
	set(OGRE_LIBRARY_NAMES_DBG ${OGRE_LIBRARY_NAMES})
else()
...
find_library(OGRE_LIBRARY_REL NAMES ${OGRE_LIBRARY_NAMES} HINTS ${OGRE_BUILD}/lib ${OGRE_LIB_SEARCH_PATH} ${OGRE_PKGC_LIBRARY_DIRS} ${OGRE_FRAMEWORK_SEARCH_PATH} PATH_SUFFIXES "" "release" "relwithdebinfo" "minsizerel")
find_library(OGRE_LIBRARY_DBG NAMES ${OGRE_LIBRARY_NAMES_DBG} HINTS ${OGRE_BUILD}/lib ${OGRE_LIB_SEARCH_PATH} ${OGRE_PKGC_LIBRARY_DIRS} ${OGRE_FRAMEWORK_SEARCH_PATH} PATH_SUFFIXES "" "debug")
...
macro(ogre_find_plugin PLUGIN HEADER)
  ...
  set(OGRE_PLUGIN_PATH_SUFFIXES
    PlugIns PlugIns/${PLUGIN_NAME}/include Plugins Plugins/${PLUGIN_NAME} ${PLUGIN} 
  ...
  if(APPLE)
     set(OGRE_${PLUGIN}_LIBRARY_NAMES_DBG ${OGRE_${PLUGIN}_LIBRARY_NAMES})
  elseif()
